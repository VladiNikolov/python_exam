...
class SpaceStation:
    ...
    def retire_astronaut(self, name: str):
        ...
        #     raise Exception(f"Astronaut {name} doesn't exist!")  same as above code
    ...
    def send_on_mission(self, planet_name: str):
        ...
        astronauts = self.astronaut_repository.find_astronauts_by_mission(5, 30)
        ...
        for astronaut in astronauts:
            ...
            while astronaut.oxygen > 0 and len(planet.items) > 0:
                astronaut.backpack.append(planet.item.pop())
                astronaut.breathe()
