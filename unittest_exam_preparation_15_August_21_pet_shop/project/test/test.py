...
class PetShopTest(TestCase):
    ...
    def test_add_food_adds_food_qty_to_existing_food(self):
        ...
        self.assertEqual("Successfully added 50.00 grams of food1.", result)
        self.assertTrue(food_name in self.pet_shop.food)
        self.assertEqual(food_quantity + add_quantity, self.pet_shop.food[food_name])
    ...
    def test_feed_returns_error_msg_when_food_name_doen_not_exist(self):
        pet_name = 'pet_name'
        self.pet_shop.pets.append(pet_name)
    ...
    def test_feed_is_adding_food_when_qty_is_less_then_100(self):
        pet_name = "pet_name"
        food_name = "food_name"
        initial_qty = 65
